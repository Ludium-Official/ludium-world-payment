...
pub trait RewardClaimUsecase {
    ...
    async fn approve_reward_claim(&self, user_id: Uuid, claim_id: Uuid, reward_claim_approve_payload: RewardClaimApprovePayload) -> Result<RewardClaimApproveResponse>;
